"""
Vercel Function: Firebase Configuration Endpoint
...
class handler(BaseHTTPRequestHandler):
    def do_GET(self):
        """Return Firebase configuration as JavaScript for client-side injection"""
        ...
        js_content = f"""// Firebase Configuration - Auto-generated from environment
